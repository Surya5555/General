...
/*	public void click(WebElement elem) throws Exception {
	...
	public void switchTotab(){
		...
		try{
		String mainwindow = ThreadLocalWebdriver.getDriver().getWindowHandle();
		String childwindow = (String) ThreadLocalWebdriver.getDriver().getWindowHandles().toArray()[1];
		ThreadLocalWebdriver.getDriver().switchTo().window(childwindow);
		
	}catch(Exception e ){
		e.printStackTrace();
		System.out.println("Error in Switching the New Tab on Clicking a Link:");
